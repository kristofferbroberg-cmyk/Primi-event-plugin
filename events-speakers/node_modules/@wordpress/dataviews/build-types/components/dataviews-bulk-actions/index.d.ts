...
export declare function BulkSelectionCheckbox<Item>({ selection, onChangeSelection, data, actions, getItemId, disableSelectAll, }: BulkSelectionCheckboxProps<Item>): import("react").JSX.Element;
