...
var defaultRender = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_stack.Stack, { ...props, direction: "column", gap: "sm" });
var Root = (0, import_element.forwardRef)(function Root2({ className, render = defaultRender, ...restProps }, ref) {
